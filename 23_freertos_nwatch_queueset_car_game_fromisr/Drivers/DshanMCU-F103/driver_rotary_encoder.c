...
void RotaryEncoder_IRQ_Callback(void)
{
    ...
    /* 写队列 */
    rotaryRecvData.cnt   = g_count;
    rotaryRecvData.speed = g_speed;
    xQueueSendToBackFromISR(g_xQueueRotary, &rotaryRecvData, &xHigherPriorityTaskWoken);
...
void RotaryEncoder_Init(void)
{
    ...
    g_xQueueRotary = xQueueCreate(ROTARY_QUEUE_LEN, sizeof(RotaryRecvData));
}

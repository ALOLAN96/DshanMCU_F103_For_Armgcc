...
#include "ascii_font.c"//此处与正点原子用法类似，需要将此文件过滤掉
...
typedef enum
{
    H_RIGHT     = 0x26,
    H_LEFT      = 0x27,
}HorizontalScrollingDirection;  // 水平滚动方向
 ...
 *  返回值：无
*/
static void OLED_H_Scroll(HorizontalScrollingDirection dir, uint8_t start, uint8_t fr_time, uint8_t end)
{
